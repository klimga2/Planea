...
const GastosMes = () => {
  ...
  return (
    <div className="gastos-mes">
      <header className="gastos-mes-header">
        <div className="gastos-mes-back-arrow" onClick={handleBackClick}>
          &lt;
        </div>
      ...
      <main>
        <div className="gastos-mes-chart-card">
          <div className="gastos-mes-chart-header">
            <h2>Mes - Octubre</h2>
            <InputDropdown
              options={options}
          ...
          <div className="gastos-mes-chart-main">
            <div className="gastos-mes-chart-tooltip">
          ...
          <div className="gastos-mes-legend">
            {data.categories.map((category, index) => (
              <div className="gastos-mes-legend-item" key={index}>
                <span
                  className="gastos-mes-dot"
        ...
        <div className="gastos-mes-summary-cards">
          {data.summary.map((item, index) => (
            <div className="gastos-mes-summary-card" key={index}>
              <h4>{item.name}</h4>
              <p>{item.amount}</p>
            </div>
          ))}
        ...
        <div className="gastos-mes-gastos-list">
          {data.gastos.map((gasto, index) => (
            <div key={index} className="gastos-mes-gasto-card">
              <div className="gastos-mes-gasto-card-header">
                <div className="gastos-mes-gasto-card-icon" style={{ color: gasto.color }}>
                  {iconMap[gasto.icono]}
                </div>
                <h3 style={{ color: gasto.color }}>{gasto.categoria}</h3>
              </div>
              <div className="gastos-mes-gasto-card-body">
                <div className="gastos-mes-gasto-item">
                  <div className="gastos-mes-progress-bar-container">
                    <div className="gastos-mes-progress-bar-wrapper">
                      <ProgressBar
                    ...
                    <span
                      className="gastos-mes-progress-bar-percentage"
